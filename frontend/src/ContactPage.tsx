...
export default function ContactPage() {
  return (
    <div className="min-h-screen bg-gray-50 dark:bg-gradient-to-br dark:from-[#0f0c29] dark:via-[#302b63] dark:to-[#24243e] text-gray-900 dark:text-gray-200 font-sans selection:bg-fuchsia-500/30 overflow-x-hidden flex items-center justify-center p-6">
      ...
      {/* Page Transition Entry Animation using CSS classes */}
      <div className="w-full max-w-xl animate-hero-entry relative z-10">
        ...
        <div className="bg-white/80 dark:bg-[#121524]/80 backdrop-blur-xl border border-gray-200 dark:border-white/10 rounded-3xl p-8 md:p-12 shadow-xl dark:shadow-[0_0_80px_rgba(217,70,239,0.15)] relative overflow-hidden">
          ...
          <form className="space-y-6 relative z-10" onSubmit={(e) => e.preventDefault()}>
            ...
            <div className="space-y-2">
              <label htmlFor="email" className="text-sm font-medium text-gray-700 dark:text-gray-300 block">Work Email</label>
              <input 
                type="email" 
                id="email" 
            ...
            <div className="space-y-2">
              ...
              <textarea 
                id="problem" 
                rows={4}
                placeholder="Describe your current bottlenecks or delay issues..." 
                className="w-full bg-gray-50 dark:bg-[#0a0c10]/50 border border-gray-300 dark:border-white/10 rounded-xl px-4 py-3 text-gray-900 dark:text-white placeholder-gray-500 dark:placeholder-gray-600 focus:outline-none focus:border-fuchsia-500/50 focus:ring-1 focus:ring-fuchsia-500/50 transition-all resize-none"
                required
              ></textarea>
            </div>
            
            <button type="submit" className="w-full bg-gradient-to-r from-[#d946ef] to-[#8b5cf6] hover:from-[#c026d3] hover:to-[#7c3aed] text-white font-semibold px-6 py-4 rounded-xl flex items-center justify-center gap-2 transition-all shadow-lg shadow-fuchsia-500/25 mt-4 group">
              Submit Request
